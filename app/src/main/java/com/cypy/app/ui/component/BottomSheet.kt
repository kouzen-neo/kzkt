/**
 * Ported from an open-source M3 component (GPL-3.0) and adapted for Cypy.
 * The spring [NavigationBarAnimationSpec] used for the initial snap is
 * inlined so the component has no dependency on the original's constants.
 */

package com.cypy.app.ui.component
...
private val bottomSheetInitialSpring = spring<Dp>(
...
fun rememberBottomSheetState(
    ...
    return remember(dismissedBound, expandedBound, collapsedBound, coroutineScope) {
        ...
        coroutineScope.launch {
            animatable.animateTo(initialValue, bottomSheetInitialSpring)
        }
