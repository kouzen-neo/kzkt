...
private val Context.dataStore: DataStore<Preferences> by preferencesDataStore(name = "cypy_settings")

/**
 * Settings persistence via DataStore Preferences.
 * Ported from the JSON settings file approach in cypy/core/config.py
 */
